...
static const CGFloat MDCTextInputLegacyFullWidthClearButtonImageSquareWidthHeight = 24.f;
static const CGFloat MDCTextInputLegacyFullWidthHintTextOpacity = 0.54f;
static const CGFloat MDCTextInputLegacyFullWidthHorizontalInnerPadding = 8.f;
static const CGFloat MDCTextInputLegacyFullWidthHorizontalPadding = 16.f;
static const CGFloat MDCTextInputLegacyFullWidthVerticalPadding = 20.f;
...
static inline UIColor *MDCTextInputLegacyFullWidthTextErrorColorDefault() {
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
  ...
  if (self) {
    ...
    _characterCountViewMode =
        [aDecoder decodeIntegerForKey:MDCTextInputControllerLegacyFullWidthCharacterCountViewModeKey];
    _errorColor = [aDecoder decodeObjectForKey:MDCTextInputControllerLegacyFullWidthErrorColorKey];
    _inlinePlaceholderColor =
        [aDecoder decodeObjectForKey:MDCTextInputControllerLegacyFullWidthInlinePlaceholderColorKey];
...
- (UIImage *)drawnClearButtonImage:(UIColor *)color {
  CGSize clearButtonSize = CGSizeMake(MDCTextInputLegacyFullWidthClearButtonImageSquareWidthHeight,
                                      MDCTextInputLegacyFullWidthClearButtonImageSquareWidthHeight);
...
+ (UIColor *)errorColorDefault {
  if (!_errorColorDefault) {
    _errorColorDefault = MDCTextInputLegacyFullWidthTextErrorColorDefault();
  }
  return _errorColorDefault;
}

+ (void)setErrorColorDefault:(UIColor *)errorColorDefault {
  _errorColorDefault = errorColorDefault ? errorColorDefault : MDCTextInputLegacyFullWidthTextErrorColorDefault();
}
  ...
  if (!self.characterCountTrailing) {
    self.characterCountTrailing =
        [NSLayoutConstraint constraintWithItem:self.textInput.trailingUnderlineLabel
                                     ...
                                     attribute:NSLayoutAttributeTrailing
                                    multiplier:1
                                      constant:-1 * MDCTextInputLegacyFullWidthHorizontalPadding];
  }
  ...
  if (!self.placeholderLeading) {
    self.placeholderLeading =
        [NSLayoutConstraint constraintWithItem:self.textInput.placeholderLabel
                                     ...
                                     attribute:NSLayoutAttributeLeading
                                    multiplier:1
                                      constant:MDCTextInputLegacyFullWidthHorizontalPadding];
  }
  if (!self.placeholderTrailingCharacterCountLeading) {
    self.placeholderTrailingCharacterCountLeading =
        [NSLayoutConstraint constraintWithItem:self.textInput.placeholderLabel
                                     ...
                                     attribute:NSLayoutAttributeLeading
                                    multiplier:1
                                      constant:-1 * MDCTextInputLegacyFullWidthHorizontalInnerPadding];
  }
  ...
  if ([self.textInput isKindOfClass:[MDCMultilineTextField class]]) {
    ...
    if (!self.multilineTextViewBottom) {
      self.multilineTextViewBottom =
                                         [NSLayoutConstraint constraintWithItem:((MDCMultilineTextField*)self.textInput).textView
                                                                      ...
                                                                      attribute:NSLayoutAttributeBottom
                                                                     multiplier:1
                                                                       constant:-1 * MDCTextInputLegacyFullWidthVerticalPadding];
    }
    if (!self.multilineTextViewTop) {
      self.multilineTextViewTop = [NSLayoutConstraint constraintWithItem:((MDCMultilineTextField*)self.textInput).textView
                                                               ...
                                                               attribute:NSLayoutAttributeTop
                                                              multiplier:1
                                                                constant:MDCTextInputLegacyFullWidthVerticalPadding];
    }
...
- (UIEdgeInsets)textInsets:(UIEdgeInsets)defaultInsets {
  ...
  textInsets.top = MDCTextInputLegacyFullWidthVerticalPadding;
  textInsets.bottom = MDCTextInputLegacyFullWidthVerticalPadding;
  textInsets.left = MDCTextInputLegacyFullWidthHorizontalPadding;
  textInsets.right = MDCTextInputLegacyFullWidthHorizontalPadding;
  ...
  if (self.textInput.text.length > 0) {
    switch (textField.clearButtonMode) {
      ...
      case UITextFieldViewModeUnlessEditing:
        ...
        editingRect.size.width += CGRectGetWidth(self.textInput.clearButton.bounds);
        editingRect.size.width -= MDCTextInputLegacyFullWidthHorizontalInnerPadding;
        break;
      default:
        break;
    }
